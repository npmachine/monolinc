defmodule MonolincWeb.UserAuthTest do
  use MonolincWeb.ConnCase

  alias Monolinc.Accounts
  alias Monolinc.Accounts.Scope
  alias MonolincWeb.UserAuth

  import Monolinc.AccountsFixtures

  @remember_me_cookie "_monolinc_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MonolincWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
